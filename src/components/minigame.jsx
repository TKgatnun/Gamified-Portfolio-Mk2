...
export default function BruteforceGame({ onComplete }) {
  ...
  const yOff = useRef(
    Array.from({ length: N }, (_, i) => (i * ((POOL * LH) / N)) % (POOL * LH)),
  );
    ...
    const tick = () => {
      for (let i = 0; i < N; i++) {
        if (!lockedR.current.has(i) && strips.current[i]) {
          ...
          strips.current[i].style.transform =
            `translateY(-${yOff.current[i]}px)`;
        }
      }
  ...
  const autoHack = useCallback(() => {
    ...
    for (let i = 0; i < N; i++) {
      ...
      yOff.current[i] = exactY;
      if (strips.current[i]) {
        strips.current[i].style.transition =
  ...
  return (
    <div
      ...
      style={{
        minHeight: "100vh",
        background:
          "radial-gradient(ellipse 120% 100% at 50% 30%, #1a4fa0, #0c2870 45%, #06133d 80%)",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        fontFamily: "VT323, monospace",
    ...
    >
      ...
      >
        ...
        <span style={{ color: "#ff3b3b", fontWeight: "bold" }}>RED</span> to
        bruteforce inside <span style={{ color: "#8fb4ff" }}>OR</span> click the{" "}
        <span style={{ color: "#00ff55", fontWeight: "bold" }}>
          AUTO HACK BOT
        </span>
        .
      </div>
      ...
      <div
        style={{
          border: "2px solid #2a5dcc",
          boxShadow:
            "0 0 50px rgba(30,80,220,0.35), 0 0 100px rgba(10,40,140,0.25)",
          background: "#04060f",
          width: 660,
          overflow: "hidden",
          outline: miss
      ...
      >
        ...
        <div
          style={{
            background:
              "linear-gradient(90deg, #001355 0%, #002f99 50%, #001355 100%)",
            padding: "6px 16px",
            display: "flex",
            alignItems: "center",
        ...
        <div style={{ padding: "18px 28px 0" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div
                style={{
                  flex: 1,
                  height: 2,
                  background: "linear-gradient(90deg, transparent, #00bb33)",
                }}
              />
              <span
                style={{
              ...
              <div
                style={{
                  flex: 1,
                  height: 2,
                  background: "linear-gradient(90deg, #00bb33, transparent)",
                }}
              />
            </div>
            <div
          ...
          >
            ...
            <div style={{ color: "#00dd33", fontSize: 28, letterSpacing: 4 }}>
              {fmt(elapsed)}
            </div>
            <div style={{ color: "#334455", fontSize: 17, letterSpacing: 1 }}>
              LEFT{" "}
              <span
                style={{ color: N - locked.length > 0 ? "#dd6633" : "#00cc33" }}
              >
                {N - locked.length}
              </span>
            </div>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: 42,
                      background:
                        "linear-gradient(180deg, #04060f, transparent)",
                      pointerEvents: "none",
                      zIndex: 4,
                    }}
                  />
          ...
          >
            <div style={{ color: "#334", fontSize: 19 }}>
              Hack the{" "}
              <span style={{ color: "#5588dd", textDecoration: "underline" }}>
                terminal
              </span>
              .
            </div>
            ...
            <div style={{ textAlign: "center" }}>
              <div
                style={{
                  ...
                  letterSpacing: 4,
                  textShadow: miss
                    ? "0 0 12px rgba(255,60,20,0.6)"
                    : "0 0 10px rgba(50,100,220,0.4)",
